...
def getopenconnection(user='postgres', password='Zhaider366!', dbname='dds_assgn1'):
...
def loadratings(ratingstablename, ratingsfilepath, openconnection):
    ...
    try:
    	with open(ratingsfilepath) as finput, open('/data/test_data.csv','w') as foutput:
    ...
    with open('/data/test_data.csv') as datafile:
    	try: 
...
def rangepartition(ratingstablename, numberofpartitions):
	...
	createtable(partitiontablename)
...
if __name__ == '__main__':
    try:
        ...
        #rangepartition("ratings", 2)
        rangeinsert("ratings", 6 ,19,150)
        with getopenconnection() as con:
           ...
           # createtable("ratings")
            ...
            #loadratings("ratings",'test_data.csv', con)
            # ###################################################################################
